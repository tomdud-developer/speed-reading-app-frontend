...
export default function PointerMedium() {
    ...
    React.useEffect(() => {
        ...
        for(let i = 0; i <= 800/fontSize/1.5; i++) {
            p = p + `L ${1045} ${1.5*i*fontSize * 2 + 35} `;
            p = p + `L 0 ${1.5*(i+1)*fontSize * 2 + 35} `;
        }
        setPath(p);
        console.log(p);
    }, []);
            ...
            <Grid container spacing={2}>
                ...
                <Grid xs={4}>
                    <Item>
                        ...
                        {
                            course.exercises.pointermedium.confirmExerciseActive &&
                            <ConfirmExerciseDone exerciseName="pointermedium" />
                        }
                    </Item>
                </Grid>
            </Grid>
